...
function createWhileExp(params, body){
	return ["WhileExp", params, body];
}

function getWhileExpParams(e){
	if(isWhileExp(e)){
		return e[1];
	}else{
		throw new Error("Interpreter error: " +
			"The argument of getWhileExpParams is not a WhileExp");
	}
}
...
function getLetRecExp(e){
	if(isLetRecExp(e)){
		...
		throw new Error("Interpreter error: " +
			"The argument of getLetRecExp is not a LetRecExp");
	}	
}
...
exports.getWhileExpParams = getWhileExpParams;

// Change the wireframe teapot into a Gouraud shaded teapot
...
// Return an array used to compute partial derivatives needs for
// vertex normals
nbezier = function(u) {
    var b = [];
    b.push(3*u*u);
...
// each quad.  It must also push the vertex normals onto their own
// vertex buffer array.  Since we are rendering triangles, six items
// are pushed for each quad in the Bezier mesh
...
// Compute all 3-D coordinates and normals on the Bezier mesh
